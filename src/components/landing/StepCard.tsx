...
export function StepCard({ step }: { step: Step }) {
  ...
  return (
    <motion.article className="relative z-10 h-full" whileHover={{ y: -4 }} transition={{ duration: 0.28, ease: 'easeOut' }}>
      <div className="flex h-full min-h-[210px] flex-col rounded-[24px] border border-emerald-100/90 bg-white/85 p-6 text-start shadow-[0_10px_28px_rgba(15,23,42,0.045)] transition-[border-color,box-shadow] duration-300 hover:border-emerald-200 hover:shadow-[0_18px_38px_rgba(15,23,42,0.1)]">
