import { AlignLeft, BookOpen, Bot, ClipboardCheck, ClipboardList, FileCheck, ListChecks, Shapes } from 'lucide-react'
...
export const teacherTools = [
  ...
  { id: 'assessment', title: 'assessment', description: 'assessmentDescription', icon: ClipboardCheck, route: '/teacher/tools/assessment', category: 'evaluation' },
  { id: 'activity', title: 'activity', description: 'activityDescription', icon: Shapes, route: '/teacher/tools/activity', category: 'activities' },
  { id: 'summary', title: 'summary', description: 'summaryDescription', icon: AlignLeft, route: '/teacher/tools/summary', category: 'preparation' },
